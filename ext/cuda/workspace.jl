...
IntervalMDP.construct_workspace(::AbstractGPUMatrix, max_actions) = CuDenseWorkspace(max_actions)
...
IntervalMDP.construct_workspace(p::AbstractCuSparseMatrix, max_actions) = CuSparseWorkspace(p, max_actions)
