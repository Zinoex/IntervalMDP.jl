@testitem "sparse/factored: show 1d" begin
    using SparseArrays
...
@testitem "sparse/factored: bellman 1d" begin
    using SparseArrays
...
@testitem "sparse/factored: bellman 2d" begin
    using SparseArrays
...
@testitem "sparse/factored: bellman 2d partial dependence" begin
    using SparseArrays
...
@testitem "sparse/factored: bellman 3d" begin
    using SparseArrays
...
@testitem "sparse/factored: bellman 3d mixed sparse/dense" begin
    using SparseArrays
...
@testitem "sparse/factored: value iteration algorithms" begin
    using SparseArrays
