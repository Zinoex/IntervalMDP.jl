@testitem "show 1d" tags = [:sparse, :show_1d] begin
    ...
    @testset for N in [Float32, Float64]
        ...
        @testset "show 1d" begin
            ...
            ambiguity_sets = IntervalAmbiguitySets(;
                lower = sparse(
                    N[0 5 // 10 2 // 10; 1 // 10 3 // 10 3 // 10; 2 // 10 1 // 10 5 // 10],
                ),
                upper = sparse(
                    N[
                        5 // 10 7 // 10 3 // 10;
...
@testitem "bellman 1d" tags = [:sparse, :bellman_1d] begin
    using IntervalMDP, SparseArrays
    using Random: MersenneTwister
    @testset for N in [Float32, Float64]
        @testset for alg in [
        ...
        @testset "bellman 1d" begin
            ambiguity_sets = IntervalAmbiguitySets(;
                lower = sparse(
                    N[0 5 // 10 2 // 10; 1 // 10 0 3 // 10; 2 // 10 1 // 10 5 // 10],
                ),
                upper = sparse(
                    N[0 7 // 10 3 // 10; 6 // 10 5 // 10 4 // 10; 7 // 10 3 // 10 5 // 10],
                ),
            )
            ...
            @testset "vertices" begin
                ...
                @test length(verts) <= 2
                expected_verts = N[0 6 // 10 4 // 10; 0 3 // 10 7 // 10]
...
@testitem "bellman 2d" tags = [:sparse, :bellman_2d] begin
    using IntervalMDP, SparseArrays
    using Random: MersenneTwister
    @testset for N in [Float32, Float64]
        @testset for alg in [
...
@testitem "bellman 2d partial dependence" tags = [:sparse, :bellman_2d_partial_dependence] begin
    using IntervalMDP, SparseArrays
    using Random: MersenneTwister
    @testset for N in [Float32, Float64]
        @testset for alg in [
...
@testitem "bellman 3d" tags = [:sparse, :bellman_3d] begin
    using IntervalMDP, SparseArrays
    using Random: MersenneTwister
    @testset for N in [Float32, Float64]
        @testset for alg in [
...
@testitem "bellman 3d mixed sparse/dense" tags = [:sparse, :bellman_3d_mixed_sparse_dense] begin
    using IntervalMDP, SparseArrays
    using Random: MersenneTwister
    @testset for N in [Float32, Float64]
        @testset for alg in [
