@testitem "data/prism: read/write round-trip" begin
    using IntervalMDP.Data
    using SparseArrays

    ## Read PRISM file
    problem = read_prism_file("multiObj_robotIMDP")
...
@testitem "data/prism: explicit file paths" begin
    using IntervalMDP.Data
    using SparseArrays
...
@testitem "data/prism: explicit file paths for reward prop" begin
    using IntervalMDP.Data
    using SparseArrays
...
@testitem "data/prism: write/read reach avoid labels" begin
    using IntervalMDP.Data
    using SparseArrays
...
@testitem "data/prism: write/read FTR props min/max" begin
    using IntervalMDP.Data
    using SparseArrays
...
@testitem "data/prism: write/read ITR props min/max" begin
    using IntervalMDP.Data
    using SparseArrays
...
@testitem "data/prism: write/read FTRA props min/max" begin
    using IntervalMDP.Data
    using SparseArrays
...
@testitem "data/prism: write/read ITRA props min/max" begin
    using IntervalMDP.Data
    using SparseArrays
...
@testitem "data/prism: write/read FTDR props min/max" begin
    using IntervalMDP.Data
    using SparseArrays
...
@testitem "data/prism: write/read ITDR props min/max" begin
    using IntervalMDP.Data
    using SparseArrays
