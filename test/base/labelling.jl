@testitem "base/labelling: DeterministicLabelling — 1d" begin
    a = UInt16[1, 3, 2, 2]
...
@testitem "base/labelling: DeterministicLabelling — 2d" begin
    a = UInt16[
        1 3 2 2
        1 3 2 5
        1 3 4 2
...
@testitem "base/labelling: DeterministicLabelling — invalid labelling" begin
...
@testitem "base/labelling: ProbabilisticLabelling — good case 1d" begin
    m = Float32[
        0.5 0.2 1 0.3
        0 0.7 0 0.4
        0.5 0.1 0 0.3
...
@testitem "base/labelling: ProbabilisticLabelling — invalid probabilities" begin
    m1 = Float32[
        0.5 1
        0.5 0
        0.1 0
