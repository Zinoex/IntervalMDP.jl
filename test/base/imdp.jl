@testitem "bellman" tags = [:base, :bellman] begin
    using IntervalMDP
    @testset for N in [Float32, Float64, Rational{BigInt}]
        ...
        prob3 = IntervalAmbiguitySets(; lower = N[0 0; 0 0; 1 1], upper = N[0 0; 0 0; 1 1])
...
@testitem "explicit sink state" tags = [:base, :explicit_sink_state] begin
    using IntervalMDP
    @testset for N in [Float32, Float64, Rational{BigInt}]
        prob1 = IntervalAmbiguitySets(;
            lower = N[0 1 // 2; 1 // 10 3 // 10; 1 // 5 1 // 10],
...
@testitem "implicit sink state" tags = [:base, :implicit_sink_state] begin
    using IntervalMDP
    @testset for N in [Float32, Float64, Rational{BigInt}]
        prob1 = IntervalAmbiguitySets(;
            lower = N[0 1 // 2; 1 // 10 3 // 10; 1 // 5 1 // 10],
