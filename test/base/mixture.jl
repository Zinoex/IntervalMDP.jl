@testitem "base/mixture: bellman 1d" tags = [:mixture] begin
    using SparseArrays
...
@testitem "base/mixture: sparse bellman 1d" tags = [:mixture] begin
    using SparseArrays
    using Random: MersenneTwister
...
@testitem "base/mixture: synthesis" tags = [:mixture] begin
    using SparseArrays
    using Random: MersenneTwister
