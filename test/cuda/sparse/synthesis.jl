@testmodule CudaSparseSynthesisModels begin
...
@testitem "cuda/sparse/synthesis: finite time reachability" setup =
    [CudaSparseSynthesisModels] tags = [:cuda] begin
    using CUDA
    using SparseArrays

    (; mdp) = CudaSparseSynthesisModels.build()
...
@testitem "cuda/sparse/synthesis: finite time reward" setup = [CudaSparseSynthesisModels] tags =
    [:cuda] begin
    using CUDA
    using SparseArrays
...
@testitem "cuda/sparse/synthesis: infinite time reachability" setup =
    [CudaSparseSynthesisModels] tags = [:cuda] begin
    using CUDA
    using SparseArrays
...
@testitem "cuda/sparse/synthesis: finite time safety" setup = [CudaSparseSynthesisModels] tags =
    [:cuda] begin
    using CUDA
    using SparseArrays
...
@testitem "cuda/sparse/synthesis: implicit sink state" setup = [CudaSparseSynthesisModels] tags =
    [:cuda] begin
    using CUDA
    using SparseArrays

    (; prob1, prob2) = CudaSparseSynthesisModels.build()
