@testitem "show 1d" tags = [:cuda, :show_1d] begin
    ...
    if CUDA.functional()
        @testset for N in [Float32, Float64]
            ...
            @testset "show 1d" begin
                ...
                @test occursin(
                    "Initial states: CartesianIndex{1}[$(CartesianIndex(2))]",
                    str,
                )
...
@testitem "show 3d" tags = [:cuda, :show_3d] begin
    using IntervalMDP, CUDA
    using Random: MersenneTwister
    if CUDA.functional()
        @testset for N in [Float32, Float64]
...
@testitem "bellman 2d" tags = [:cuda, :bellman_2d] begin
    using IntervalMDP, CUDA
    using Random: MersenneTwister
    if CUDA.functional()
        @testset for N in [Float32, Float64]
...
@testitem "bellman 3d" tags = [:cuda, :bellman_3d] begin
    using IntervalMDP, CUDA
    using Random: MersenneTwister
    if CUDA.functional()
        @testset for N in [Float32, Float64]
...
@testitem "4D rand" tags = [:cuda, :_4d_rand] begin
    using IntervalMDP, CUDA
    using Random: MersenneTwister
    if CUDA.functional()
        @testset for N in [Float32, Float64]
...
@testitem "5D rand" tags = [:cuda, :_5d_rand] begin
    using IntervalMDP, CUDA
    using Random: MersenneTwister
    if CUDA.functional()
        @testset for N in [Float32, Float64]
...
@testitem "synthesis" tags = [:cuda, :synthesis] begin
    using IntervalMDP, CUDA
    using Random: MersenneTwister
    if CUDA.functional()
        @testset for N in [Float32, Float64]
