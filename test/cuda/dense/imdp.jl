@testmodule CudaDenseImdpModels begin
...
@testitem "cuda/dense/imdp: construction" setup = [CudaDenseImdpModels] tags = [:cuda] begin
    using CUDA

    @testset for N in [Float32, Float64]
        (; transition_probs) = CudaDenseImdpModels.build(N)
        istates = [1]
...
@testitem "cuda/dense/imdp: bellman" setup = [CudaDenseImdpModels] tags = [:cuda] begin
    using CUDA
...
@testitem "cuda/dense/imdp: explicit sink — IntervalMarkovChain dimension mismatch" setup =
    [CudaDenseImdpModels] tags = [:cuda] begin
    using CUDA
...
@testitem "cuda/dense/imdp: explicit sink — finite time reachability" setup =
    [CudaDenseImdpModels] tags = [:cuda] begin
    using CUDA
...
@testitem "cuda/dense/imdp: explicit sink — infinite time reachability" setup =
    [CudaDenseImdpModels] tags = [:cuda] begin
    using CUDA
...
@testitem "cuda/dense/imdp: explicit sink — exact time reachability" setup =
    [CudaDenseImdpModels] tags = [:cuda] begin
    using CUDA
...
@testitem "cuda/dense/imdp: explicit sink — finite time reach/avoid" setup =
    [CudaDenseImdpModels] tags = [:cuda] begin
    using CUDA
...
@testitem "cuda/dense/imdp: explicit sink — infinite time reach/avoid" setup =
    [CudaDenseImdpModels] tags = [:cuda] begin
    using CUDA
...
@testitem "cuda/dense/imdp: explicit sink — exact time reach/avoid" setup =
    [CudaDenseImdpModels] tags = [:cuda] begin
    using CUDA
...
@testitem "cuda/dense/imdp: explicit sink — finite time reward" setup =
    [CudaDenseImdpModels] tags = [:cuda] begin
    using CUDA
...
@testitem "cuda/dense/imdp: explicit sink — infinite time reward" setup =
    [CudaDenseImdpModels] tags = [:cuda] begin
    using CUDA
...
@testitem "cuda/dense/imdp: explicit sink — expected exit time" setup =
    [CudaDenseImdpModels] tags = [:cuda] begin
    using CUDA
...
@testitem "cuda/dense/imdp: implicit sink — finite time reachability" setup =
    [CudaDenseImdpModels] tags = [:cuda] begin
    using CUDA

    @testset for N in [Float32, Float64]
        (; prob1, prob2, transition_probs) = CudaDenseImdpModels.build(N)
        mdp = IntervalMDP.cu(IntervalMarkovDecisionProcess(transition_probs))
...
@testitem "cuda/dense/imdp: implicit sink — infinite time reachability" setup =
    [CudaDenseImdpModels] tags = [:cuda] begin
    using CUDA
...
@testitem "cuda/dense/imdp: implicit sink — exact time reachability" setup =
    [CudaDenseImdpModels] tags = [:cuda] begin
    using CUDA
...
@testitem "cuda/dense/imdp: implicit sink — finite time reach/avoid" setup =
    [CudaDenseImdpModels] tags = [:cuda] begin
    using CUDA
...
@testitem "cuda/dense/imdp: implicit sink — infinite time reach/avoid" setup =
    [CudaDenseImdpModels] tags = [:cuda] begin
    using CUDA
...
@testitem "cuda/dense/imdp: implicit sink — exact time reach/avoid" setup =
    [CudaDenseImdpModels] tags = [:cuda] begin
    using CUDA
...
@testitem "cuda/dense/imdp: implicit sink — finite time reward" setup =
    [CudaDenseImdpModels] tags = [:cuda] begin
    using CUDA
...
@testitem "cuda/dense/imdp: implicit sink — infinite time reward" setup =
    [CudaDenseImdpModels] tags = [:cuda] begin
    using CUDA
...
@testitem "cuda/dense/imdp: implicit sink — expected exit time" setup =
    [CudaDenseImdpModels] tags = [:cuda] begin
    using CUDA
